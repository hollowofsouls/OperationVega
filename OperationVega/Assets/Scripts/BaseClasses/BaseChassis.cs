...
namespace Assets.Scripts.BaseClasses
{
	...
	/// The base chassis.
	/// </summary>
	public class BaseChassis : IRocketParts
	{
		/// <summary>
		/// The steel.
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="BaseChassis"/> class.
		/// </summary>
		public BaseChassis()
		{
		}
		...
		/// The quality.
		/// </param>
		public BaseChassis(uint steelcost, uint fuelcost, uint qualities)
		{
